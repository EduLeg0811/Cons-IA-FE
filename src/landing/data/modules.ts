...
export const landingCategories: LandingCategory[] = [
  ...
  },
  {
    ...
    landingDescription: 'Bibliomancia digital, quiz, flashcards, mapa mental, infográfico e podcast.',
    ...
    items: [
      ...
      },
      {
        ...
        external: true,
        moduleKey: 'quiz_conscienciologico',
      },
      {
      ...
      },
      {
        ...
        external: true,
        moduleKey: 'infografico_paradigma',
      },
      {
        title: 'Podcast I',
        description: 'Do estado vibracional à evolução multidimensional.',
        icon: Headphones,
        href: 'https://notebooklm.link.google/vvohHByfcQJS',
        external: true,
        moduleKey: 'podcast_ev',
      },

      {
        title: 'Podcast II',
        description: 'A lógica da evolução além da biologia.',
        icon: Headphones,
        href: 'https://notebooklm.link.google/axGm4lLXJiTi',
        external: true,
        moduleKey: 'podcast_evolucao',
      },
    ],
  },
  {
